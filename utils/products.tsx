export const products = [
  ...
  {
    id: "64a7c8e6b5f81a6bca3d451e",
    name: "Dell XPS 13 9310 Touchscreen Laptop",
    description:
      "13.4-inch FHD+ touchscreen, Intel Core i7, 16GB RAM, 512GB SSD, Windows 10 Home, Platinum Silver with Black Interior.",
    price: 1299.99,
    brand: "Dell",
    category: "Laptop",
    inStock: true,
    ...
    reviews: [
      {
        rating: 4,
        comment: "Great laptop, but the battery life could be better.",
      },
    ],
  },
  {
    id: "64a7c8e6b5f81a6bca3d451f",
    ...
    reviews: [
      {
        rating: 5,
        comment: "Amazing performance and display quality.",
      },
    ],
  },
  {
