    ...
    const sections = [
        {
            ...
            links: ["Phones", "Laptops", "Desktops", "Watches", "Tv's", "Phones", "Accessories"]
        },
        {
            title: "Customer Services",
            links: ["Contact US", "Shipping policy", "Returns and Exchanges", "Watches", "FAQs"]
        }
    ];
                ...
                <div className="flex flex-col md:flex-row justify-between pt-16 pb-8">
                    ...
                    <div className="w-full md:w-1/3 md-6">
                        ...
                        <p className="mb-2">
                            ...
                            and accessories to our customers. With a wide selection of phones, TV's, laptops, watches, and accessories.
                        </p>
                        <p>&copy; {new Date().getFullYear()} ZapMart: All rights reserved</p>
                    </div>
                    <FooterList>
                        <h3 className="text-base font-bold mb-2">Follow us</h3>
                        <div className="flex gap-2">
                            {socialMediaLinks.map(({ icon: Icon, href }, index) => (
                                <Link key={index} href={href}><Icon size={24} /></Link>
                            ))}
                        </div>
                    </FooterList>
                </div>
